...
Public Class etihouse
    Private dt As New DataTable
    Private Sub etihouse_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        mostrar()
    ...
    Private Sub mostrar()
        ...
        Try
            Dim func As New farticuloshouse
            dt = func.mostrar
    ...
    Private Sub btnprinteti_Click(sender As Object, e As EventArgs) Handles btnprinteti.Click
        ...
        If chk55x32.Checked = True Then
            ...
            's = s + "^LL0256" & vbCrLf
            's = s + "^LS0" & vbCrLf
            's = s + "^FT10,86^A0N,11,12^FH\^FD" & txtnombre.Text & "^FS" & vbCrLf
            's = s + "^FT10,104^A0N,11,12^FH\^FDC/Logo Sustentabilidad^FS" & vbCrLf
            's = s + "^FT11,132^A0N,14,14^FH\^FDFamilia:^FS" & vbCrLf
            's = s + "^FT65,132^A0N,14,14^FH\^FD" & txtfamilia.Text & "^FS" & vbCrLf
            's = s + "^FT11,150^A0N,14,14^FH\^FDMarca Destino:^FS" & vbCrLf
            's = s + "^FT104,150^A0N,14,14^FH\^FD" & txtdestino.Text & "^FS" & vbCrLf
            's = s + "^FO7,160^GB425,0,3^FS" & vbCrLf
            's = s + "^BY2,2.5,67^FT17,227^B3N,N,,Y,N" & vbCrLf
            's = s + "^FD" & txtcodigo.Text & "^FS" & vbCrLf
            's = s + "^FT8,62^A0N,56,50^FH\^FD" & txtcodigo.Text & "^FS" & vbCrLf
        ...
        ElseIf chk30x20.Checked = True Then
            ...
            s = s + "f100" & vbCrLf
            s = s + "N" & vbCrLf
            s = s + "B798,84,2,3,1,3,59,B," & """" & txtcodigo.Text & """" & vbCrLf
            ...
            s = s + "B518,84,2,3,1,3,59,B," & """" & txtcodigo.Text & """" & vbCrLf
            ...
            s = s + "B239,84,2,3,1,3,59,B," & """" & txtcodigo.Text & """" & vbCrLf
